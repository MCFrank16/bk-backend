...
fs_1.default.promises.readdir(__dirname).then((components) => __awaiter(void 0, void 0, void 0, function* () {
    for (const component of components) {
        try {
            if (fs_1.default.existsSync(`${__dirname}/${component}/router.ts`)) {
                const module = yield Promise.resolve(`${`./${component}/router`}`).then(s => __importStar(require(s)));
